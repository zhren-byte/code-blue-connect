...
<body onLoad=search()>
        ...
        <div class="wrapper">
            ...
            <div class="main-container">
                <div class="main-header">
                    <div class="header-menu">
                        <a class="main-header-link is-active" href="#llamados">Llamados</a>
    ...
    <script>
        ...
        function search(){
            let search = $('.search-bar input').val().toLowerCase();
            $.ajax({
                type:"GET",
                url: "./notifications.php",
                data: { search: search, {'query':query,'location':location,'status':status,'per_page':per_page} },
                success: (res) => {
